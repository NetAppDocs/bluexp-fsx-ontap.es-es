...
Puede descubrir los sistemas de archivos FSx para ONTAP cuando usted <<Cree un entorno de trabajo de Amazon FSX para ONTAP de NetApp>> O mediante el uso de la página *Mi estado*. Esta tarea describe el descubrimiento usando *Mi estado*
